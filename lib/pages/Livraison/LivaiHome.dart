...
class livaison extends StatefulWidget {
  const livaison({ Key? key }) : super(key: key);

  @override
  State<livaison> createState() => _livaisonState();
}

class _livaisonState extends State<livaison> {
  @override
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: Lottie.network('https://assets5.lottiefiles.com/packages/lf20_jm1zwwig.json'),
                ),
              ),
              ...
              child: Container(
                ...
                child: professionnel('SERVICE DE LIVRAISON', 'Les destinations les plus\npopulaires a prix abordable.', 'Suivant',),
              ),)
            ],
          ),
        )
