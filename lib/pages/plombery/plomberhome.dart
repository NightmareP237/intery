...
class plomber extends StatefulWidget {
  const plomber({ Key? key }) : super(key: key);

  @override
  State<plomber> createState() => _plomberState();
}

class _plomberState extends State<plomber> {
  @override
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: Lottie.network('https://assets9.lottiefiles.com/packages/lf20_teqtg9.json'),
                ),
              ),
              ...
              child: Container(
                ...
                child: professionnel('SERVICE DE PLOMBERIE', 'Pour vos problemes de fuites\nVeuillez prendre rendez-vous.', 'Suivant',),
              ),)
            ],
          ),
        )
                     ...
                     !internet? showSimpleNotification(
                      ...
                      Color,
                                    ...
                                    if (internet) {
                                      ...
                                      deadwifi(context, internet, plombery());
                                    }
                                  },
                                  child: Container(
