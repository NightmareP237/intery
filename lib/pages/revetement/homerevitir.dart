...
class revetement extends StatefulWidget {
  const  revetement({ Key? key }) : super(key: key);

  @override
  State< revetement> createState() => _revetementState();
}

class _revetementState extends State<revetement> {
  @override
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: Lottie.network('https://assets7.lottiefiles.com/packages/lf20_twxv8mn4.json'),
                ),
              ),
                     ...
                     !internet? showSimpleNotification(
                      ...
                      Color,
                                    ...
                                    if (internet) {
                                      ...
                                      deadwifi(context, internet,  revetir());
                                    }
                                  },
                                  child: Container(
