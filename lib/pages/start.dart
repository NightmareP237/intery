...
import 'package:interyapp/pages/select_service.dart';
...
class _StartPageState extends State<StartPage> {
  List<Service> services = [
    ...
    Service('Renovation', 'https://img.icons8.com/fluency/2x/drill.png'),
    Service('Botanique',
    ...
    Service('Coiffeur', 'https://img.icons8.com/fluency/2x/sewing-machine.png'),
    Service(
        'Entretien', 'https://img.icons8.com/color/2x/housekeeper-female.png'),
    Service('Livraison',
                  ...
                  children: [
                    ...
                    FadeAnimation(
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              'Facile et pratique,Nous vous offrons des services de qualite a domicile.',
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                fontSize: 16,
  ...
  serviceContainer(String image, String name, int index) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selectedService == index ? Colors.white : Colors.black45,
          border: Border.all(
